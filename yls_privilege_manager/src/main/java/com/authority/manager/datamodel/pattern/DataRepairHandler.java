 ...
 * @Description: 职责链模式结构：具体处理者-数据修复
 * @Version 1.0
 */
public class DataRepairHandler extends ProcessModelHandler {

    private static  final Logger LOGGER = LoggerFactory.getLogger(DataRepairHandler.class);

    public DataRepairHandler(String name) {
        super(name);
    }
