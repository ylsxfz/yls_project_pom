...
INSERT INTO `sys_menu` VALUES (2, NULL, NULL, 0, NULL, NULL, 'el-icon-service', '用户管理', 1, 1, NULL, 1, '/sys/sysTestMybatisUser');
INSERT INTO `sys_menu` VALUES (3, NULL, NULL, 0, NULL, NULL, NULL, '查看', 0, 2, 'sys:sysTestMybatisUser:view', 2, NULL);
INSERT INTO `sys_menu` VALUES (4, NULL, NULL, 0, NULL, NULL, NULL, '新增', 0, 2, 'sys:sysTestMybatisUser:add', 2, NULL);
INSERT INTO `sys_menu` VALUES (5, NULL, NULL, 0, NULL, NULL, NULL, '修改', 0, 2, 'sys:sysTestMybatisUser:edit', 2, NULL);
INSERT INTO `sys_menu` VALUES (6, NULL, NULL, 0, NULL, NULL, NULL, '删除', 0, 2, 'sys:sysTestMybatisUser:delete', 2, NULL);
